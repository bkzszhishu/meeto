...
import com.yusi.yusimeetobackend.mapper.UserMapper;
...
import static com.yusi.yusimeetobackend.constant.UserConstant.USER_LOGIN_STATE;
...
public class UserServiceImpl extends ServiceImpl<UserMapper, User>
    ...
    public String getEncryptPassword(String userPassword) {
        //这里不能将密码直接加密，要添加盐值，以混淆密码，因为攻击者可能会猜到我们使用的加密算法，这样就容易破解
        final String SALT = "yusi";
